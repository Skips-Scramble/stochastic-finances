var_descriptions = {
    ...
    "add_healthcare": "Select this to automatically include model-driven healthcare costs (including Medicare premiums at age 65+). This is separate from your own monthly medical bills estimate.",
    ...
    "add_medical_bills": "Select this to include your own monthly estimate for out-of-pocket medical bills (e.g. prescriptions, copays, dental). This is a custom amount and is independent of the automatic health care costs option above. This will be inflation-adjusted each year.",
