var_descriptions = {
    ...
    "medicare_coverage_type": "Select your Medicare coverage type. 'Standard Medicare' adds Part B and Part D premiums for months when you are age 65 or older. Select 'None' if you do not want Medicare premiums included.",
    "private_insurance_per_mo": "If you plan to retire before age 65, enter your estimated monthly private insurance premium (in today's dollars). This cost will be applied from your retirement date until you reach Medicare eligibility at age 65. Leave blank if retiring at 65 or later.",
