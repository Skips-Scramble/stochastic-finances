var_descriptions = {
    ...
    "include_pre_medicare_insurance": "If you plan to retire before age 65, select this to automatically include an ACA insurance cost from your retirement date until you reach Medicare eligibility at age 65. The cost is inflation-adjusted each January using your input inflation rate.",
    "add_medical_bills": "Select this if you would like to include a monthly estimate for out-of-pocket medical bills (e.g. prescriptions, copays, dental). This will be inflation-adjusted each year.",
    "monthly_medical_bills": "The estimated monthly amount you expect to pay in out-of-pocket medical expenses. This will be inflation-adjusted over time.",
    "base_savings": "This is the amount of money you have in your savings account(s) right now.",
    "base_saved_per_mo": 'This is the amount of money you save each month and contribute to your savings account(s). A negative amount would represent you are spending that amount each month. If this is the case, it would probably be better to put a 0 in this field and move those payments to the "Payments" section.',
    ...
    "retirement_type": "Please choose from one of the standard retirement account types (including HSA and Brokerage)",
    "base_retirement": "The amount of money you have in your retirement account(s) right now.",
    "base_retirement_per_mo": "The amount of money that gets contributed to your retirement account each month. This includes all contributions, including employer contributions. For pensions, enter the expected monthly payment in today's dollars — it will be automatically adjusted for inflation.",
    ...
    "pension_start_age_yrs": "The age in years when your pension payments will begin. For example, if your pension starts at age 62 and 6 months, put 62 here.",
    "pension_start_age_mos": "The age in months when your pension payments will begin. For example, if your pension starts at age 62 and 6 months, put 6 here.",
